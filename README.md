...
We uploaded ScTypeDB, a combination of PanglaoDB and CellMarker, as cell-type marker database, tested its performance in cell-type annotation. ScTypeDB is compatible to annotation via MACA.
